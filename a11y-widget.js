...
.a11yw-btn{
  ...
  background:var(--a11y-brand); color:#fff; display:grid; place-items:center;
...
.a11yw-head{
  background:var(--a11y-brand); color:#fff; padding:16px 18px;
